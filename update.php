...
<body>
    ...
    <div class="infor">
        <div class="col-sm-5">
            <div class="form-data">
                <div class="form-head">
                    <h2 style="color: black">Edit Products</h2>
                </div>
                <div class="form-body">
                    <form action="update1.php" method="POST" enctype="multipart/form-data">
                        ...
                        <span>
                            <input type="text" name="product_id"  value="<?php echo $mn?>" class="form-control">
                        </span>
                        </div>
                       <div class="row form-row">
                          <label>Quantity: </label>
                            <span>
                              <input type="text" name="quantity"  value="<?php echo $ln?>" class="form-control">
                            </span>
                        </div>
                        <div class="row form-row">
                        <label>Price: </label>
                        <span>
                            <input type="text" name="price" value="<?php echo $pn?>" class="form-control">
                        </span>
                        </div>
                        <!--div class="row form-row">
                            <label>Address: </label>
